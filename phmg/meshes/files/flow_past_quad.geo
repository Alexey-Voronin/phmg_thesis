...
cl1 = 0.4;            // Characteristic length (mesh size) near the cylinder
cl2 = 1.0;             // Characteristic length (mesh size) away from the cylinder
...
Physical Line("Walls") = {1, 3, 5, 6, 7, 8};
